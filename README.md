...
PIMFY Photo는 유기견의 상황에 최적화된 **3가지 프로필 생성 모드**를 지원합니다.

### 🧡 1. 핌피바이러스 프로필
- **데이터 기반 시각화**: 핌피바이러스 DB의 실시간 공고 데이터와 연동하여, 유기동물의 기본 정보를 구조화된 프로필 이미지로 변환합니다.

### 🏠 2. 입양·임보 프로필
- **페르소나 기반 배경 합성**: 유기견의 성격과 특징을 AI가 분석하여, 차가운 보호소 배경 대신 안락하고 따뜻한 공간이 반영된 정서적 프로필을 생성합니다.

### 📸 3. 스튜디오 프로필
- **고해상도 AI 리터칭**: SDXL 및 Real-ESRGAN 모델을 활용하여 전문 스튜디오 수준의 조명과 질감이 반영된 고품질 '견생샷'을 제공합니다.
